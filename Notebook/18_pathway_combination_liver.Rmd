...
#pdf("~/Desktop/Nanostring_mRNA_project/Plots/LIVER_expression_heatmap.pdf", height = 6, width = 14)
...
```{r}
all_data <- do.call(rbind, c(edit_list))
...
all_data <- all_data%>%
  ...
  ungroup()
saveRDS(all_data,"~/Desktop/Nanostring_mRNA_project/output_files/liver_combination_comp2.rds")
```

```{r}

all_data <- readRDS("~/Desktop/Nanostring_mRNA_project/output_files/liver_combination_comp2.rds")
matx <- all_data
...
pdf("~/Desktop/Nanostring_mRNA_project/Plots/liver_combination_comp2.pdf", height = 6, width = 14)
p1
```
